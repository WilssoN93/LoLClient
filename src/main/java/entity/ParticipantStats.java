...
public class ParticipantStats {
    ...
    private long magicDamageDealtToChampion;
    ...
    public long getMagicDamageDealtToChampion() {
        return magicDamageDealtToChampion;
    }

    public void setMagicDamageDealtToChampion(long magicDamageDealtToChampion) {
        this.magicDamageDealtToChampion = magicDamageDealtToChampion;
    }
    ...
    public String toString() {
        return "ParticipantStats{" +
                ...
                ", magicDamageDealtToChampion=" + magicDamageDealtToChampion +
